export enum DescripcionProyecto {

  GUACHIMAN = `Este sistema consta de un backend utilizando Spring Boot que opera mediante microservicios.
  ...
  CCAFAST = `CCAFast es una aplicación web desarrollada principalmente con Angular en el front-end y SpringBoot en el back-end.
 ...
 También permite activar o desactivar contingencias para pausar las transferencias entre bancos`,
  ...
  AUTOSERVICIORRHH = `Autoservicio RR-HH es una aplicación web desarrollada con React JS en el front-end y Node.js en el back-end.
 ...
 como consultar sus liquidaciones, solicitar vacaciones, firmar documentos, responder encuestas, entre otras.`,
  ...
  RENTACAR = `Rentacar es una aplicación CRM (Customer Relationship Management) desarrollada con Angular en el front-end y Express.js en el back-end.
 ...
 incluyendo funciones como tomar fotografías del estado de los vehículos antes y después del arrendamiento, realizar cálculos de consumo de combustible y elementos de viaje.
  ...
  TESIS = `El Sistema de Evidencias (SE) es una aplicación web que busca mejorar el proceso de acreditación de las carreras de la UCM.
